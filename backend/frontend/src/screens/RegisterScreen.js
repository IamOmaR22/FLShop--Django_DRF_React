...
function RegisterScreen({ location, history }) {
    ...
    const userRegister = useSelector(state => state.userRegister)  // userRegister from store.js
    const { error, loading, userInfo } = userRegister   // Pull out error, loading, userInfo from userReducers.js
